...
void rottop_st(stack_t **head, unsigned int counter);
...
void push_st(stack_t **head, unsigned int number);
void p_all_st(stack_t **head, unsigned int number);
void p_top_st(stack_t **head, unsigned int number);
